...
struct Protowire_KaspadRequest: Sendable {
...
struct Protowire_KaspadResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Protowire_KaspadRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".KaspadRequest"
  ...
  static func ==(lhs: Protowire_KaspadRequest, rhs: Protowire_KaspadRequest) -> Bool {
...
extension Protowire_KaspadResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".KaspadResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    101: .same(proto: "id"),
  ...
  static func ==(lhs: Protowire_KaspadResponse, rhs: Protowire_KaspadResponse) -> Bool {
